...
export function ProjectCard({ project }: { project: GitHubRepository }) {
  return (
    ...
    >
      <h3 className="text-xl font-bold text-primary-anti-flash-white mb-2 group-hover:text-primary-mountain-meadow transition-colors">
        {project.name}
      </h3>
      <p className="text-sm text-secondary-stone mb-4 line-clamp-2">
