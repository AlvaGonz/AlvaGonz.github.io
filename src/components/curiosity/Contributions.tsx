    ...
    return (
        <section id="contributions" className="py-12 md:py-20">
            <FadeInOnScroll variant="fadeUp">
                <h2 className="text-3xl md:text-4xl font-bold mb-8 text-curiousity-accent border-b-2 border-curiousity-accent/30 pb-2 inline-block">
                    Contributions
                </h2>
            </FadeInOnScroll>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {[
                    ...
                    <FadeInOnScroll key={item.title} delay={i * 0.1} variant="fadeUp">
                        <motion.div
                            whileHover={{ y: -5 }}
                            className="bg-theme-surface p-6 rounded-xl border border-theme-border hover:border-curiousity-accent/50 transition-colors h-full"
                        >
                            <div className="text-4xl mb-4">{item.icon}</div>
                            <h3 className="text-xl font-bold text-theme-text mb-2">{item.title}</h3>
                            <span className="inline-block px-2 py-1 rounded bg-curiousity-accent/10 text-curiousity-accent text-xs font-bold mb-3">
                                {item.role}
                            </span>
