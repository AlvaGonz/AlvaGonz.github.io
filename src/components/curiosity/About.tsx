          ...
          <div className="relative">
            ...
            <div className="relative bg-theme-surface p-8 rounded-xl border border-theme-border shadow-xl">
              ...
              <p className="text-lg text-theme-text-secondary leading-relaxed mb-4">
                ...
                <strong className="text-theme-primary">faith, community, and Curiosity</strong>. I
              ...
              <p className="text-lg text-theme-text-secondary leading-relaxed mb-4">
                ...
                <span className="text-green-400">green</span> (obviously), the adrenaline of{' '}
                <span className="text-orange-400">gaming</span>, and the discipline of{' '}
                <span className="text-purple-400">design</span>. Whether I'm managing multimedia for
