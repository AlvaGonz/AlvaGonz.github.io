...
const LANGUAGE_FACTS: Record<string, string> = {
  TypeScript:
    'A superset of JavaScript that adds static types. It was created by Anders Hejlsberg, who also designed C#.',
  JavaScript:
    "Created in just 10 days by Brendan Eich in 1995. It's the only language that runs natively in web browsers.",
  Python:
    "Named after Monty Python's Flying Circus, not the snake. It emphasizes code readability and simplicity.",
  ...
  React:
    'A JavaScript library for building user interfaces. It was created by Jordan Walke at Facebook.',
  ...
  Shell:
    'A command-line interpreter that provides a user interface for the Unix-like operating systems.',
  ...
  Swift:
    "Created by Apple for iOS and macOS development. It's designed to be safe, fast, and interactive.",
  Kotlin:
    "A modern language for the JVM. It's now the preferred language for Android app development.",
...
export function LanguageMindMap() {
  ...
  return (
    <div
      className="relative w-full h-[600px] bg-black rounded-3xl overflow-hidden border border-white/10 shadow-2xl"
      ref={containerRef}
    >
